// Dafny program firstDafny.dfy compiled into C#
...
// Command-line arguments: run --no-verify f:\9.semester\Seminar\DAIMPL\example\first_Example\firstDafny.dfy
// firstDafny.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static void TestMax()
    {
      BigInteger _0_res;
      BigInteger _out0;
      _out0 = __default.Max(new BigInteger(3), new BigInteger(4));
      _0_res = _out0;
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      __default.TestMax();
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Hello World from Dafny!")).ToVerbatimString(false));
    }
  }
